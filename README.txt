To run this Java program, open the program2 folder with terminal.
Or simply type: cd "folder directory" with the actual path of the folder on your computer.
...
The input.txt above is which input file you will like to be tested.
Change the "input.txt" with an actual path of the input file.